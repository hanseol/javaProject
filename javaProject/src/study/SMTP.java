...
public class SMTP {
	public static void main(String[] args) {
		...
		final String userId = "gkstjf22";
		final String userPw = "DLFRUTWHG1!!";

		try {
			String sender = "gkstjf22@naver.com"; // 보내는사람 메일주소. ex) mailSender@naver.com
			...
			toAddr[0] = new InternetAddress("gimjaban2@naver.com");
